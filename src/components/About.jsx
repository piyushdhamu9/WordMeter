  ...
  return (
    <div className='m-auto flex h-[90%] w-[90%] flex-col gap-7 py-10 font-mono text-lg'>
      <div className='flex flex-col gap-3'>
        <h1 className='text-3xl font-bold'>About Word Meter</h1>
        <p className=''>
          Word Meter is a minimalistic typing speed testing app built with React
      ...
      <div className=' mt-auto flex flex-col gap-1'>
        <div className='flex items-center gap-3'>
          ...
          ,
          <a
            href='https://www.linkedin.com/in/piyushdhamu9/'
            target='_blank'
            className='hover:underline'
            rel='noopener noreferrer'
          >
        ...
        {/* <div className='flex items-center gap-3'>
          ...
          <a
            href='http://github.com/Estifanos12/Word Meter'
            target='_blank'
            className='hover:underline'
            rel='noopener noreferrer'
          >
