...
export const isAllowedCode = (code) => {
  return (
    code.startsWith('Key') ||
    code === 'Backspace' ||
    code === 'Space' ||
...
export const generateWord = (n) => {
  return faker.word.words(n);
};

export const calculateAccuracy = (expectedWord, typedWord) => {
  let correctChars = 0;
...
export const calculateWPM = (typedWord, accuracy, time) => {
