...
import { BsQuestionCircle, BsKeyboardFill } from 'react-icons/bs';
...
const Header = ({ restart, openAboutModal }) => {
  ...
  return (
    <header className='flex items-center justify-between py-8'>
      ...
      >
        ...
        <h1 className={`font-mono text-2xl font-bold hover:underline lg:text-3xl`}>
          WordMeter.
        </h1>
